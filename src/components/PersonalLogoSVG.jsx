const PersonalLogoSVG = (props) => (
  <svg
    ...
    {...props}
  >
    <style type="text/css">{`.st0{fill:#5F4F96;}`}</style>
    <g>
      <path
        className="st0"
        d="M297.5,199.9c-86.6,0-157.1,63.6-157.1,141.9v255.7c0,19.8,17.8,35.9,39.8,35.9c21.9,0,39.8-16.1,39.8-35.9
...
export default PersonalLogoSVG; 